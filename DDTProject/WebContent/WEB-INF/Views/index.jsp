          ...
          <div class="row">
            <div class="col-sm-6">
              <!-- <div id="accordion-container">
                ...
                <section>
                  <a href="#contact" id="contact" data-toggle="collapse" data-target="#accordion-form1">
                    <h1>SDTT: Trainer/Schedule Confirmation</h1>
                  </a>
                  <div id="accordion-form1" class="collapse">

                    <table>
                      <tr>
                        <td>
                          <class="hfas fas fa-user-tie" title="Trainer Name"><label>Trainer Name</label></class>
                        </td>
                        <td>
                          <datalist id="trainerdatalist">
                            <option value="Mahesh Rajput">Stevie Nicks</option>
                            <option value="Some Guy">John Travolta</option>
                            <option value="Copyrighted Character">Yo Noid!</option>
                          </datalist>
                          <input type="text" name="trainer" list="trainerdatalist" />
                        </td>
                      <tr>
                        <td>
                          <class="hfas fas fa-check" title="Trainer Acceptance"><label>Trainer Acceptance</label></class>
                        </td>
                        <td>
                          <input type="checkbox" />
                        </td>
                ...
                <section>
                  <a href="#info" id="info" data-toggle="collapse" data-target="#accordion-form2">
                    <h1>Approval Status</h1>
                  </a>
                  <div id="accordion-form2" class="collapse">
                    <table>
                      <tr>
                        <td>
                          <class="hfas fas fa-user-tie" title="Trainer Name"><label>Status</label></class>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <class="hfas fas fa-check" title="Trainer Acceptance"><label>P.M Acceptance</label></class>
                        </td>
                        <td>
                          <input type="checkbox" />
                        </td>
                ...
                <section>
                  <a href="#intro" id="intro" data-toggle="collapse" data-target="#accordion-form3">
                    <h1>Logistics</h1>
                  </a>
                  <div id="accordion-form3" class="collapse">
                    <form>
                      <table>
                        <tr>
                          <td><i class="hfas fas fa-map-marker" title="Location"> Enter Location</td>
                        </tr>
                        <tr>
                          <td><i class="hfas fas">City: <input type="text" style="width: 90px; margin-left: 30px" /><br>State:
                              <input type="text" style="width: 30px; margin-left: 25px" /><br>Country: <input type="text"
                                style="width: 90px; margin-left: 2px" /><br>Zip: <input type="text" style="width: 90px; margin-left: 36px" /></i></td>
                        </tr>
                      </table>
                      <br>
                      <table>
                        <tr>
                          <td><i class="hfas fas fa-book" title="Classroom"> Enter Room Number</td>
                        </tr>
                        <tr>
                          <td><i class="hfas fas">Room Number: <input type="text" style="width: 50px; margin-left: 5px"></i></td>
                        </tr>
                      </table>
                      <br>
                      ...
                      <table>
                        <tr>
                          <td><i class="hfas fas fa-desktop" title="Online"> Enter Class URL</td>
                        </tr>
                        <tr>
                          <td><i class="hfas fas">URL: <input type="text" style="width: 150px;" /></i></td>
                        </tr>
                      </table>
                      <br>
                      <table>
                        <tr>
                          <td><i class="hfas fas">Training Summary: </i><br><br></ve><textarea style="height: 140px"></textarea></td>
                        </tr>
                      </table>
                    </form>
                  </div>
 ...
 <div id="popover_content_wrapper" style="display: none;">
    ...
    <div class="row">
      <div class="col-sm-2">
        ...
        <div>
          ...
          <br>
          <table class="newTrainTable2" border="4px" width='180px' style="border-radius: 9px; border-color:royalblue; box-shadow: -5px 5px grey">
            <tr>
          ...
          <br>
          <table class="newTrainTable3" border="4px" width='180px' style="border-radius: 9px; border-color:royalblue; box-shadow: -5px 5px grey">
            <tr>
  ...
  <footer>
    <div class="container-fluid">
      <div class="row">
        <div class="col-xl-10">
          <img id="asflogo" src="./imgs/footerlogo.png" alt="">
        </div>
