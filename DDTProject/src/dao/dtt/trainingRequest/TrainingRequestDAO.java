...
public class TrainingRequestDAO 
{
	...
	public void updateTrainingRequest(int requester_id,String vertical,String request_training_type,
	...
	{
		temp.update("update Training_Request set requester_id=?,vertical=?,request_training_type=?"
				...
				+ "request_approx_participant=?,request_project_spoc=?,time_requested=?,"
